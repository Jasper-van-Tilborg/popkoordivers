                  ...
                  {upcoming.map((event, i) => (
                    ...
                    >
                      ...
                      <div style={{ textAlign: "center" }}>
                        ...
                        <p style={{ margin: "4px 0 0", fontSize: "13px", color: "#aaa", fontWeight: 600 }}>
                          {event.year}
                        </p>
                      </div>
                      ...
                      <div style={{ minWidth: 0 }}>
                        ...
                        <p style={{ margin: "0 0 8px", fontSize: "14px", color: "#666", lineHeight: 1.5 }}>
                          {event.description}
                        </p>
            ...
            {tab === "archief" && (
              <>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "32px", flexWrap: "wrap", gap: "16px" }}>
                  ...
                  <a
                    href="#"
                    style={{ fontSize: "13px", fontWeight: 600, color: "var(--primary)", textDecoration: "none", borderBottom: "2px solid rgba(243,106,42,0.25)", paddingBottom: "2px" }}
                  >
                    Naar fotoalbums →
                  </a>
                </div>
                ...
                <a
                  href="#"
                  style={{ display: "inline-flex", marginTop: "24px", fontSize: "13px", fontWeight: 600, color: "var(--primary)", textDecoration: "none", borderBottom: "2px solid rgba(243,106,42,0.25)", paddingBottom: "2px" }}
                >
                  Volledig archief →
                </a>
              </>
